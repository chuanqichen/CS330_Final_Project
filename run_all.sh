...
CUDA_VISIBLE_DEVICES=1 python maml.py --num_way 4 --num_support 1 --num_query 1  --log_dir ./logs_new_lstm_conv4 --data_folder ./data/v1.csv &
CUDA_VISIBLE_DEVICES=0 python maml.py --num_way 3 --num_support 1 --num_query 1  --log_dir ./logs_new_lstm_conv4 --data_folder ./data/v1.csv &
CUDA_VISIBLE_DEVICES=0 python maml.py --num_way 2 --num_support 1 --num_query 1  --log_dir ./logs_new_lstm_conv4 --data_folder ./data/v1.csv &

CUDA_VISIBLE_DEVICES=0 python protonet.py --num_way 4 --num_support 1 --num_query 1  --log_dir ./logs_new_lstm_conv4 --data_folder ./data/v1.csv &
CUDA_VISIBLE_DEVICES=1 python protonet.py --num_way 3 --num_support 1 --num_query 1  --log_dir ./logs_new_lstm_conv4 --data_folder ./data/v1.csv &
CUDA_VISIBLE_DEVICES=1 python protonet.py --num_way 2 --num_support 1 --num_query 1  --log_dir ./logs_new_lstm_conv4 --data_folder ./data/v1.csv &
