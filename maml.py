...
class MAML:
    ...
    def _inner_loop(self, images, labels, train):
        ...
        for i in range(self._num_inner_steps+1):
            ...
            gradient_fun = autograd.grad(loss, 
    ...
    def _outer_step(self, task_batch, train):
        ...
        for task in task_batch:
            ...
            loss_query = F.cross_entropy(logits, labels_query)            
    ...
    def test(self, dataloader_test):
        ...
        for i, task_batch in enumerate(dataloader_test):
            ...
            outer_loss, accuracies_support, accuracy_query = self._outer_step(task_batch, train=(i<k))
            if i<k:
                outer_loss.backward()
                self._optimizer.step()
